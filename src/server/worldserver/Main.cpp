...
char serviceLongName[] = "StormCore world service";
char serviceDescription[] = "StormCore World of Warcraft emulator world service";
/*
...
extern int main(int argc, char** argv)
{
    ...
    Trinity::Banner::Show("worldserver-daemon",
        ...
        []()
        {
			TC_LOG_INFO("server.worldserver", "Project StormCore 2014-2017(c) Legion Patch 7.1.5");
			TC_LOG_INFO("server.worldserver", "Repository: https://github.com/Ragebones/StormCore");
			TC_LOG_INFO("server.worldserver", "Copyright: StormCore");
